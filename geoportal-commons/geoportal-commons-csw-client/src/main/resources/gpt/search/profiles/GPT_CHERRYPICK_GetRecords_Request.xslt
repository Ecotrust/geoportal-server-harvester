                ...
                <ogc:And>
                  ...
                  <ogc:Or>
                    <ogc:PropertyIsEqualTo>
                      ...
                      <!-- <ogc:Literal>normalize-space($rootFilterKeyword/param[@name='SearchText']/@value)</ogc:Literal> -->
                      <ogc:Literal value="normalize-space($rootFilterKeyword/param[@name='SearchText']/@value)" />
                    </ogc:PropertyIsEqualTo>
                    <ogc:PropertyIsEqualTo>
