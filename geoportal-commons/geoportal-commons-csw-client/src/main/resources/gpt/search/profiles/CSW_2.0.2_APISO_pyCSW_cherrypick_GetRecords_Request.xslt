...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<xsl:element name="csw:GetRecords" use-attribute-sets="GetRecordsAttributes" xmlns:csw="http://www.opengis.net/cat/csw/2.0.2" xmlns:ogc="http://www.opengis.net/ogc" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:gml="http://www.opengis.net/gml" xmlns:gmd="http://www.isotc211.org/2005/gmd">
		    ...
		    <csw:ElementSetName>full</csw:ElementSetName>
				<!-- <xsl:if test="count(/GetRecords/Envelope) + count(/GetRecords/KeyWord) &gt; 1"> -->
	...
	<xsl:template match="/GetRecords/KeyWord" xmlns:ogc="http://www.opengis.net/ogc">
		...
		<ogc:PropertyIsEqualTo>
			...
			<ogc:Literal>
				<xsl:call-template name="output-cherrypick-ids">
					<xsl:with-param name="list">
						<xsl:value-of select="." />
					</xsl:with-param>
				</xsl:call-template>
			</ogc:Literal>
			<!-- <ogc:Literal>gov.noaa.nmfs.inport:39284</ogc:Literal> -->
		</ogc:PropertyIsEqualTo>
		<!-- <ogc:PropertyIsEqualTo>
			<ogc:PropertyName>dc:identifier</ogc:PropertyName>
			<ogc:Literal>gov.noaa.ngdc.mgg.dem:umpqua_river_p180_30m</ogc:Literal>
		</ogc:PropertyIsEqualTo> -->
	</xsl:template>
  ...
  <xsl:template name="string-replace-all">
	...
	<xsl:template name="output-cherrypick-ids">
		<xsl:param name="list" />
