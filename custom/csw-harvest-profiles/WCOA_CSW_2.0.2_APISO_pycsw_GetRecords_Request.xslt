...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/GetRecords/KeyWord" xmlns:ogc="http://www.opengis.net/ogc">
        ...
        <ogc:Or>
					...
					<!-- IOOS records -->
					<!-- https://data.ioos.us/csw?request=GetCapabilities&service=CSW&version=2.0.2  -->

					<!-- [CENCOOS] Southeast Papa - 600 NM West of Eureka, CA (46006) -->
					<ogc:PropertyIsEqualTo>
						<ogc:PropertyName>dc:identifier</ogc:PropertyName>
						<ogc:Literal>wmo_46006</ogc:Literal>
					</ogc:PropertyIsEqualTo>

					<!-- [NANOOS] Regional Ocean Modeling System (ROMS): Oregon Coast -->
					<ogc:PropertyIsEqualTo>
						<ogc:PropertyName>dc:identifier</ogc:PropertyName>
						<ogc:Literal>OCOS</ogc:Literal>
					</ogc:PropertyIsEqualTo>

					<!-- [GLOS] Enhance Great Lakes beach recreational water quality decision making -->
					<ogc:PropertyIsEqualTo>
						<ogc:PropertyName>dc:identifier</ogc:PropertyName>
						<ogc:Literal>53598190e4b0031b2f4a070c</ogc:Literal>
					</ogc:PropertyIsEqualTo>

					<!-- [MARACOOS] ROMS ESPRESSO Real-Time Operational IS4DVAR Forecast System Version 1 (OLD) 2009-2013 Averages -->
					<ogc:PropertyIsEqualTo>
						<ogc:PropertyName>dc:identifier</ogc:PropertyName>
						<ogc:Literal>edu.rutgers.marine:espresso_2009_da_averages</ogc:Literal>
					</ogc:PropertyIsEqualTo>
